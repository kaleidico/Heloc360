...
import { CheckCircle, Users, Target, Shield, Heart, Award, TrendingUp, Home } from "lucide-react"
    ...
    <>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white">
              <h1 className="text-4xl md:text-5xl font-bold mb-6">Turning Home Equity Into Opportunity</h1>
              <p className="text-xl mb-8 opacity-90 leading-relaxed">
                At HELOC360, we believe every homeowner should have access to their home's equity. We're here to
                simplify the process, provide expert guidance, and connect you with the right lenders.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  ...
                  asChild
                >
                  <Link href="/heloc-101">Learn About HELOCs</Link>
                </Button>
              </div>
            </div>
            <div className="relative">
              <Image
                src="https://sjc.microlink.io/8wLO6uYvE3Zzpu_8ULO2UPCeAqsuCMO2LSuGjEQ6tVECWKHvB_RIWfvKbz6VbRHcSGKV0G7Bb5Dc3Mbkk0U6wA.jpeg"
                alt="Professional woman with glasses holding tablet in modern office environment"
                width={600}
                height={400}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1b75bc] mb-4">Our Story</h2>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-semibold text-[#1b75bc] mb-4">Why We Started HELOC360</h3>
                <p className="text-gray-700 mb-6 leading-relaxed">
                  After years of working in traditional mortgage lending, our founders saw how complicated and
                  intimidating the home equity process had become. Homeowners with significant equity were struggling to
                  access it, often getting lost in complex paperwork and confusing terms.
                </p>
                <p className="text-gray-700 mb-6 leading-relaxed">
                  We knew there had to be a better way. That's why we created HELOC360 - to be the bridge between
                  homeowners and the equity they've built, making the process transparent, educational, and accessible.
                </p>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-[#02c39a] mt-1 flex-shrink-0" />
                    <span className="text-gray-700">Founded in 2020 by mortgage industry veterans</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-[#02c39a] mt-1 flex-shrink-0" />
                    <span className="text-gray-700">Helped over 10,000 homeowners access their equity</span>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle className="w-5 h-5 text-[#02c39a] mt-1 flex-shrink-0" />
                    <span className="text-gray-700">Partnered with 50+ vetted lenders nationwide</span>
                  </div>
                </div>
              </div>
              <div>
                <Image
                  src="/placeholder.svg?height=400&width=600&text=Company+Story+Image"
                  alt="HELOC360 team collaborating in modern office space"
                  width={600}
                  height={400}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1b75bc] mb-4">Our Values</h2>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              <Card className="text-center border-t-4 border-t-[#1b75bc]">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    We believe in clear communication, honest advice, and no hidden fees. You'll always know exactly
                    what to expect.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-t-4 border-t-[#02c39a]">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    Your success is our success. Every decision we make is guided by what's best for our customers and
              ...
              <Card className="text-center border-t-4 border-t-purple-500">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    We're committed to providing exceptional service, expert guidance, and the best possible outcomes
                    for every customer.
                  </p>
                </CardContent>
              </Card>
              ...
              <Card className="text-center border-t-4 border-t-orange-500">
                ...
                <CardContent>
                  <p className="text-gray-600">
                    We empower homeowners with knowledge, providing the education and tools needed to make informed
                    financial decisions.
                  </p>
                </CardContent>
              </Card>
      ...
      <section id="team" className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1b75bc] mb-4">Meet Our Team</h2>
...
dTitle>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1b75bc] mb-6">Our Mission</h2>
            <p className="text-xl text-gray-700 mb-8 leading-relaxed">
              To democratize access to home equity by providing homeowners with the education, tools, and connections
            ...
            <div className="bg-gradient-to-r from-[#1b75bc]/10 to-[#02c39a]/10 p-8 rounded-lg">
              <h3 className="text-2xl font-semibold text-[#1b75bc] mb-4">What This Means for You</h3>
              <div className="grid md:grid-cols-3 gap-6 text-left">
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Expert Guidance</h4>
                  <p className="text-gray-600 text-sm">
                    Our team of mortgage professionals provides personalized advice tailored to your unique situation.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">Vetted Partners</h4>
                  <p className="text-gray-600 text-sm">
                    We work only with reputable, licensed lenders who meet our strict standards for service and rates.
                  </p>
                </div>
                <div>
                  <h4 className="font-semibold text-gray-900 mb-2">No Hidden Costs</h4>
                  <p className="text-gray-600 text-sm">
                    Our service is completely free to homeowners. We're compensated by our lender partners, not you.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1b75bc] mb-4">Awards & Recognition</h2>
              <p className="text-lg text-gray-600">Recognized for excellence in customer service and innovation</p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Best Customer Service</CardTitle>
                  <p className="text-gray-600">FinTech Awards 2023</p>
                </CardHeader>
              </Card>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <p className="text-gray-600">Mortgage Tech 2023</p>
                </CardHeader>
              </Card>
              ...
              <Card className="text-center">
                <CardHeader>
                  ...
                  <CardTitle className="text-lg">Top Rated Platform</CardTitle>
                  <p className="text-gray-600">Consumer Choice 2023</p>
                </CardHeader>
              </Card>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Join thousands of homeowners who have successfully accessed their home equity with HELOC360's help.
            </p>
            ...
            <p className="text-sm mt-4 opacity-80">
              Free consultation • No obligation • Expert guidance every step of the way
            </p>
          </div>
        </div>
      </section>
