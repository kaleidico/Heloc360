...
export default function ContactPage() {
  ...
  const isFormValid =
    formData.firstName && formData.lastName && formData.email && formData.reason && formData.message && formData.consent
      ...
      <section className="bg-gradient-to-r from-[#1b75bc] to-[#02c39a] py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center text-white">
            <h1 className="text-4xl md:text-5xl font-bold mb-6">Contact Our HELOC Experts</h1>
            <p className="text-xl mb-8 opacity-90">
              Ready to unlock your home's equity? Our team is here to guide you through every step of the process.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-[#1b75bc] mb-4">Get in Touch</h2>
              ...
              {contactMethods.map((method, index) => (
                <Card key={index} className="text-center hover:shadow-lg transition-shadow">
                  <CardHeader>
                    ...
                    <CardTitle className="text-xl text-[#1b75bc]">{method.title}</CardTitle>
                  </CardHeader>
                  <CardContent>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12">
              {/* Form */}
              <div>
                <h2 className="text-3xl font-bold text-[#1b75bc] mb-6">Send Us a Message</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <label htmlFor="consent" className="text-sm text-gray-700 leading-relaxed">
                      I agree to be contacted by HELOC360 regarding my inquiry. I understand that I may receive calls,
                      texts, or emails, and I can opt out at any time. View our{" "}
                      <Link href="/privacy" className="text-[#1b75bc] hover:text-[#02c39a] underline">
                        Privacy Policy
                      </Link>{" "}
                      and{" "}
                      <Link href="/communication-consent" className="text-[#1b75bc] hover:text-[#02c39a] underline">
              ...
              <div className="space-y-8">
                ...
                <Card>
                  <CardHeader>
                    <CardTitle className="text-xl text-[#1b75bc]">Before You Contact Us</CardTitle>
                  </CardHeader>
                  <CardContent>
                    <p className="text-gray-600 text-sm mb-4">
                      You might find the answer to your question in these helpful resources:
                    </p>
                ...
                <Card className="bg-yellow-50 border-yellow-200">
                  <CardContent className="pt-6">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <h4 className="font-semibold text-yellow-800 mb-2">Urgent Matters</h4>
                        <p className="text-yellow-700 text-sm mb-3">
                          For time-sensitive issues related to your loan application or closing, please call us directly
      ...
      <section className="py-16 bg-gradient-to-r from-[#1b75bc] to-[#02c39a]">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center text-white">
            ...
            <p className="text-xl mb-8 opacity-90">
              Don't wait to unlock your home's potential. Get pre-qualified today and see what options are available to
              you.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-white text-[#1b75bc] hover:bg-gray-100">
              ...
              <Button
                ...
                asChild
              >
                <Link href="/heloc-101">Learn More About HELOCs</Link>
              </Button>
            </div>
          </div>
        </div>
