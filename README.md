...
### Accessing the Form
Navigate to `/get-started` to access the form.

### Testing the Form
1. Start the development server: `npm run dev`
2. Visit `http://localhost:3000/get-started`
...
```
http://localhost:3000/get-started?utm_source=google&utm_medium=cpc&utm_campaign=test&gclid=test123
```
