...
// proseSection uses LegalPortableText, which supports ONLY these block styles:
...
// and a single list style: bullet → <ul className="list-disc pl-6 mb-8 space-y-2">.
// Link annotations: { _type:'link', href, external? }. external=true adds the
...
// alertCallout / infoCard bodies use a 'normal'-only block array.
const an = (children, markDefs = []) => ({ _type: 'block', _key: k('b'), style: 'normal', markDefs, children })

// proseSection wrapper: one constrained-width rich-text run (py-16 / container /
// max-w-4xl / prose). Each maps to one "section group" of the source page.
const prose = (body) => ({ _type: 'proseSection', _key: k('sec'), body, maxWidth: '4xl' })

// iconHeading: bare H2 with leading lucide icon (the icon'd H2 groups).
...
const sections = [
  ...
  prose([
    p([s('This website is owned and operated by My Perfect Leads LLC, 1121 Annapolis RD #218, Odenton, MD 21113, which is referred to below as "My Perfect Leads" or "we" or "us" or "Company" or "our."')]),
  ]),
  ...
  prose([
    p([s('You agree that:')]),
    // NOTE: source renders these as an ORDERED (numbered) list; proseSection only
    // exposes a bullet list, so they are seeded as bullets. (See report — gap.)
    uli([s('your use of this website is subject to and governed by these Terms of Use,')]),
    uli([s('you will only access or use this website and transact business with us if you are at least 18 years old,')]),
    uli([s('you will comply with and be bound by these Terms of Use as they appear on this website each time you access and use this website,')]),
    uli([s('each use of this website by you indicates and confirms your assent to and agreement to be bound by these Terms of Use, and')]),
    uli([s('these Terms of Use are a legally binding agreement between you and My Perfect Leads that will be enforceable against you.')]),
    ...
    uli([s('that interferes with or induces a breach of the contractual relationships between My Perfect Leads and its employees,')]),
    uli([s('that is any way unlawful or prohibited, or that is harmful or destructive to anyone or their property,')]),
    uli([s('that transmits any advertisements, solicitations, schemes, spam, flooding, or other unsolicited email, unsolicited commercial communications,')]),
    uli([s('that transmits any harmful or disabling computer codes or viruses,')]),
    uli([s('that harvests email addresses from this site,')]),
    uli([s('that transmits unsolicited email to this site or to anyone whose email address included the domain name under on this website,')]),
    uli([s('that interferes with our network services;')]),
    uli([s('that attempts to gain unauthorized access to our network services,')]),
    uli([s('that suggests an express or implied affiliation with My Perfect Leads or broker relationship with My Perfect Leads (without the express written permission of My Perfect Leads),')]),
    uli([s("that impairs or limits our ability to operate this website or any other person's ability to access and use this website, and/or")]),
    uli([s('that uses any methods, means or devices to click on to this website or cause a visit to this website for the purpose of manipulating the results of any Internet search engine, or for any other purpose other than conducting mortgage banking related business with My Perfect Leads as a bona fide client of My Perfect Leads.')]),
    uli([s('that unlawfully impersonates or otherwise misrepresents your affiliation with any person or entity;')]),
    uli([s('that harms minors in any way, including, but not limited to, transmitting or uploading content that violates child pornography laws, child sexual exploitation laws and laws prohibiting the depiction of minors engaged in sexual conduct;')]),
    uli([s('that transmits or uploads pornographic, violent, obscene, sexually explicit, discriminatory, hateful, threatening, abusive, defamatory, offensive, harassing, or otherwise objectionable content or images;')]),
    uli([s('that harms, threatens, harasses, abuses or intimidates another person in any way or involves images or content that depicts, promotes, encourages, indicates, advocates or tends to incite the commission of a crime or other unlawful activities;')]),
    uli([s('that dilutes or depreciates the name and reputation of My Perfect Leads or any of its affiliates;')]),
    uli([s("that transmits or uploads any content or images that infringes any third party's intellectual property rights or infringes any third party's right of privacy; or")]),
    uli([s('that unlawfully transmits or uploads any confidential, proprietary or trade secret information.')]),
  ]),

  // --- 3. Access to this Website (no icon) ----------------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Access to this Website')] },
    p([s('My Perfect Leads reserves the right at all times, in its sole discretion and without notice to you, to deny your access to and use of this website.')]),
  ]),

  // --- 4. Use of this Website (no icon) -------------------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Use of this Website')] },
    p([s('You agree and acknowledge that you have the sole responsibility and liability for your use of this website and for providing or obtaining, and for maintaining, all of the hardware, software, electrical power, telecommunications, Internet services, and other products or services necessary or desirable for you to access and use this website.')]),
  ]),

  // --- 5. Intellectual Property Rights (no icon) ----------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Intellectual Property Rights')] },
  ...
  // --- 6. Linking (no icon) -------------------------------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Linking')] },
    ...
    p([s('My Perfect Leads does not permit third-party advertising on this website. Except with the written permission of My Perfect Leads, you agree that you will not create links from any website or Web page to this website or any Web page within this website.')]),
  ]),

  // --- 7. Privacy and Security (no icon) ------------------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Privacy and Security')] },
    ...
    p([s("Because of the financial nature of our business, our websites are not designed to appeal to children under the age of 13. Therefore, we don't knowingly attempt to solicit or receive any information from children.")]),
  ]),

  // --- 8. Communications with Company (no icon) -----------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Communications with Company')] },
  ]),
  {
    _type: 'alertCallout',
    _key: k('sec'),
  ...
  prose([
    h3('Loan Approvals:'),
    p([s('All loan approvals, pre-qualifications, pre-approvals, rate locks, deposit and refund agreements, and the like, are only made by My Perfect Leads in writing. Approvals, pre-qualifications and pre-approvals are conditional in accordance with the terms, except as specifically provided for in writing signed by My Perfect Leads.')]),
    h3('Credit Reports:'),
    p([s('By applying for credit, you are authorizing My Perfect Leads to obtain a copy of your credit report. As a result, a "hard" inquiry may appear on your credit report. A hard inquiry may negatively affect your credit score.')]),
    h3('Recording & Monitoring of Communications:'),
    p([s('Your communications with us via the website, chat email, and telephone may be recorded or monitored and by using such communications methods you are consenting to the recording or monitoring of the same.')]),
  ]),

  // --- 9. Disclaimers (no icon) ---------------------------------------------
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Disclaimers')] },
  ...
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Your California Privacy Rights')] },
  ...
  prose([
    { _type: 'block', _key: k('b'), style: 'h2', markDefs: [], children: [span('Equal Opportunity Employer')] },
    p(
      [
...
console.log('section types:', res.sections.map((x) => x._type).join(', '))
